...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "als_run":        (".als",                                      "als_run"),
    "find_ap_threshold":   (".ap_threshold",                              "find_ap_threshold"),
    ...
    "medial_from":         (".st_boundary",                               "medial_from"),
    "perpendicular_of":    (".st_boundary",                               "perpendicular_of"),
    "raw_preview":         (".st_boundary",                               "raw_preview"),
    "load_st_bd":          (".st_boundary",                               "load_st_bd"),
    "save_st_bd":          (".st_boundary",                               "save_st_bd"),
    "anchor_curve":       (".st_boundary",                               "anchor_curve"),
    ...
    "label_regions":       (".st_boundary",                               "label_regions"),
    "region_at":           (".st_boundary",                               "region_at"),
    "lateral_check":       (".st_boundary",                               "lateral_check"),
