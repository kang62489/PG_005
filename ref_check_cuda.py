...
# Set CUDA 11.8 environment variables BEFORE importing Numba
...
os.environ['NUMBAPRO_NVVM'] = r'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\nvvm\bin\nvvm64_40_0.dll'
os.environ['NUMBAPRO_LIBDEVICE'] = r'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\nvvm\libdevice'
os.environ['NUMBA_CUDA_DRIVER'] = r'C:\Windows\System32\nvcuda.dll'

# Update PATH to prioritize CUDA 11.8
cuda_11_8_bin = r'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\bin'
cuda_11_8_libnvvp = r'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\libnvvp'
current_path = os.environ['PATH']
# Remove CUDA 10.0 paths
current_path = current_path.replace(r'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.0\bin;', '')
current_path = current_path.replace(r'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.0\libnvvp;', '')
# Add CUDA 11.8 paths at the beginning
os.environ['PATH'] = f'{cuda_11_8_bin};{cuda_11_8_libnvvp};{current_path}'

# Third-party imports (AFTER setting environment variables)
import pynvml
