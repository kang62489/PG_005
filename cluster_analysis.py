...
if lst_img_segments:
    ...
    seg_idx = 0  # Change this to test different segments
    ...
    # Apply k-means to all frames in this segment using concatenated approach
    clustered_frames, cluster_centers = process_segment_kmeans_concatenated(test_seg, n_clusters=3)
