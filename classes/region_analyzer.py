...
Region analysis of one spike-aligned median segment (categorized + raw-intensity stacks).
  ...
  Step 4. Flow   : pre-masked TV-L1 flow, spike-1->spike ... spike+3->spike+4 (compute_flow())
...
class RegionAnalyzer:
    ...
    def compute_flow(self, cat_stack: np.ndarray, med_stack: np.ndarray) -> list[dict]:
        """Pre-masked TV-L1 flow pairs around the spike (see functions/hotspot_flow.py); stored as flow_pairs."""
